          ...
          <div className='flex -space-x-2'>
            ...
            <div className='hs-dropdown relative inline-flex [--placement:right-top]'>
              <button
                ...
                className='hs-dropdown-toggle inline-flex items-center justify-center h-[2rem] w-[2rem] rounded-full bg-gray-200 border-2 border-white font-medium text-gray-700 shadow-sm align-middle hover:bg-gray-300 focus:outline-none focus:bg-teal-100 focus:text-teal-600 focus:ring-2 focus:ring-offset-1 focus:ring-offset-white focus:ring-teal-600 transition-all text-sm'
              >
        ...
        <div className='flex gap-6 justify-center'>
          <div className='block w-80 p-3 bg-gray-100 rounded-md shadow-none'>
            <div className=' flex justify-between mt-1 mb-3'>
              <h1 className='inline-flex items-center gap-1.5 text-sm font-semibold text-gray-700 uppercase'>
                To do{' '}
                <span className='py-1 px-2 rounded-full text-xs font-medium bg-red-200 text-red-800'>
                  6
                </span>
              </h1>
              <button
                data-hs-overlay='#create-issue'
          ...
          <div className='block w-80 p-3 bg-gray-100 rounded-md shadow-none'>
            <div className=' flex justify-between mt-1 mb-3'>
              <h1 className='inline-flex items-center gap-1.5 text-sm font-semibold text-gray-700 uppercase'>
                In Progress{' '}
                <span className='py-1 px-2 rounded-full text-xs font-medium bg-amber-200 text-amber-800'>
                  3
                </span>
              </h1>
          ...
          <div className='block w-80 p-3 bg-gray-100 rounded-md shadow-none'>
            <div className=' flex justify-between mt-1 mb-3'>
              <h1 className='inline-flex items-center gap-1.5 text-sm font-semibold text-gray-700 uppercase'>
                Done{' '}
                <span className=' py-1 px-2 rounded-full text-xs font-medium bg-green-200 text-green-800'>
                  4
                </span>
              </h1>
