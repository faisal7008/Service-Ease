  ...
  return (
    <div className="status inline-flex items-center gap-2 hs-dropdown">
      ...
      { current === "In Progress" && <button
        id="hs-dropdown-default"
        className="hs-dropdown-toggle font-semibold text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded text-xs px-4 py-2 text-center inline-flex items-center uppercase"
        type="button"
      >
        {current}{" "}
        <svg
