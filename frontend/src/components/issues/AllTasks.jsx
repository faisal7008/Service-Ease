...
export default function AllTasks() {
  ...
  const {issues, isSuccess, isError, isLoading} = useSelector(state => state.issues)
  ...
  }, [projectId, dispatch, isSuccess, isError, isLoading])
    ...
    <div className="flex gap-6 justify-center">
      <div className="block w-80 p-3 bg-gray-100 rounded-md shadow-none">
        ...
        <div className=" grid grid-cols-1 gap-2">
          {myIssues?.filter(issue => issue.status === "To Do").map(issue => (
            // <Draggable>
