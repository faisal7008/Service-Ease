  ...
  return (
    <div className="status inline-flex items-center gap-2 hs-dropdown">
      <button
        ...
        type="button"
      >
        { current === "To Do" && <span className="font-semibold focus:ring-4 focus:outline-none rounded text-xs px-4 py-2 text-center inline-flex items-center uppercase text-gray-900 bg-gray-300 hover:bg-gray-300 focus:ring-gray-200">
        {current}{" "}
        <svg
        ...
        { current === "In Progress" && <span className="font-semibold focus:ring-4 focus:outline-none rounded text-xs px-4 py-2 text-center inline-flex items-center uppercase text-gray-900 bg-gray-300 hover:bg-gray-300 focus:ring-gray-200">
        {current}{" "}
        <svg
          className="ml-2 w-4 h-4"
          aria-hidden="true"
