                ...
                >
                  <div className="max-h-[75vh] px-1 my-4 overflow-auto">
                    ...
                    <div className="mb-4">
                      ...
                      <div
                        id="assignee1"
                        className="hs-dropdown w-full relative inline-block"
                      >
                        <button
                        ...
                        >
                          <div className="py-2 max-h-44 overflow-auto first:pt-0 last:pb-0">
                            {filteredUsers.map((user) => (
                              <button
                                key={user._id}
                                onClick={() => {setAssignee(user); setIssueData(prev => {return {...prev, assignee_id: user._id}})}}
                                type="button"
                    ...
                    <div className="mb-4">
                      ...
                      >
                        ...
                        >
                          <div className="py-2 max-h-44 overflow-auto first:pt-0 last:pb-0">
                            <button className="flex items-center w-full gap-x-3.5 py-2 px-3 rounded text-sm text-rose-600 hover:bg-gray-100" type="button">
                              <UserBox user={user} />
                            </button>
                          </div>
                        </div>
                    ...
                    <div className="mb-4 w-1/2 grid grid-cols-2 gap-6">
                      ...
                      <div className="relative w-full">
                        ...
                        <input
                          type="date"
                          onChange={(e) => setIssueData(prev => { return {...prev, duedate: e.target.value} })}
                          id="duedate"
