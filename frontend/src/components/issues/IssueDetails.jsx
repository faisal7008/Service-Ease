              ...
              <div className='relative flex gap-6'>
                <div className=' overflow-y-auto max-h-[67vh] space-y-2 p-2 w-4/6 '>
                  ...
                  <button
                    ...
                    className=' text-xs font-medium bg-slate-200 px-3 py-2 rounded hover:bg-slate-300'
                  >
                    <i className='fas fa-paperclip fa-lg'></i> Attach files
                  </button>
                  <div className='description'>
                    <h1 className=' mt-4 mb-1 font-semibold text-sm'>Description</h1>
                  ...
                  <div className='activity'>
                    ...
                    <div className='mt-2'>{issueId && <AllComments issueId={issueId} />}</div>
                  </div>
                </div>
                    ...
                    <div className='timestamps bottom-0 space-y-1 p-3'>
                      <h1 className=' text-xs mb-6 font-normal text-gray-500'>
                        ...
                        <span className='font-semibold text-sm'>
                          {moment(issue.duedate).format('ll')}
                        </span>
                      </h1>
