...
export default function Navbar({ userNavigation, navigation, user }) {
  ...
  useEffect(() => {
    navigation.filter(item => item.current === true).map(item => {
  ...
  {/* <!-- ========== MAIN CONTENT ========== --> */}
  {/* <!-- Sidebar Toggle --> */}
  <div className={heading !== "Community" ? " top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:block dark:bg-gray-800 dark:border-gray-700" : "hidden"}>
