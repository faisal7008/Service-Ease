    ...
    <div>
      <div className='bg-gray-50 dark:bg-slate-900'>
        ...
        <a className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">Brand</a>
            ...
            <button
              type='button'
              className='inline-flex sm:hidden items-center text-gray-500 hover:text-gray-600'
            ...
            >
              ...
              <span className=' ml-2 -mt-1 text-2xl font-medium text-slate-900'>
              ...
              <div className='hidden sm:block'>
                ...
                >
                  ...
                  {current === 'community' ? (
                    <span className=' ml-2 -mt-1 text-2xl font-medium text-slate-900'>
                      Service<span className='text-3xl ml-1 mr-1 text-teal-500'>@</span>Ease{' '}
                      <span className=' font-light ml-1'> Community </span>
                    </span>
                  ) : (
                    <span className=' ml-2 -mt-1 text-2xl font-medium text-slate-900'>
                      Service<span className='text-3xl ml-1 mr-1 text-teal-500'>@</span>Ease
            ...
            <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <path d="M16 3a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                ...
                <div className='hs-dropdown relative inline-flex [--placement:bottom-right]'>
                  ...
                  <div
                    className='hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 z-50 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700'
        ...
        >
          <div className='px-6'>
            <span className='text-lg font-mono font-medium text-slate-900'>
              Service<span className='text-xl ml-1 mr-1 text-teal-500'>@</span>Ease
            </span>
          </div>
