            ...
            <div className='flex items-center p-4'>
              ...
              <div className='ml-2'>
                <button
                  ...
                  className='inline-flex flex-shrink-0 justify-center items-center p-2 rounded-full text-green-400 hover:bg-green-200 transition-all text-xs'
                >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='mb-4'>
            ...
            <textarea
              ...
              rows='4'
              className='block p-2.5 w-full text-sm resize-none text-gray-900 bg-gray-50 rounded border border-gray-300 focus:ring-teal-500 focus:border-teal-500'
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              id='key'
              className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5'
              placeholder='Write a unique key for your project'
              defaultValue={project.key}
              required
            />
          </div>
          <div className='mb-4 hs-dropdown space-y-2'>
            <label for='team' className='mb-2 text-xs font-semibold text-gray-900 dark:text-white'>
              Add team members <span className=' text-rose-600'>*</span>
            </label>
            <div className='relative hs-dropdown-toggle' tabIndex={0} id='hs-dropdown-with-icons'>
              <input
                ...
                id='team'
                className='block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded border border-gray-300 focus:ring-teal-500 focus:border-teal-500'
          ...
          <div className='mb-4 h-full w-full grid grid-cols-2 gap-2 place-content-evenly'>
            {members.map((member) => (
              <div
                key={member._id}
                className='flex justify-between border px-2 py-1.5 bg-gray-200 rounded items-center w-full'
              >
                ...
                <button
                  ...
                  onClick={() =>
                    setMembers((prev) => prev.filter((user) => user._id !== member._id))
                  }
                >
                  <svg
                    aria-hidden='true'
          ...
          <button
            type='submit'
            className='mt-2 text-white bg-teal-700 hover:bg-teal-800 w-max focus:ring-4 focus:ring-teal-300 font-medium rounded text-sm px-8 py-2.5 mr-2'
          >
            {' '}
            Save
          </button>
