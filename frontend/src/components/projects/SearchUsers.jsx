...
export default function SearchUsers({ filteredUsers, setMembers, setSearchField }) {
  return (
    <div className={filteredUsers.length > 0 ? "block" : "hidden"}>
      <div className="hs-dropdown-menu transition-[opacity,margin] duration max-h-56 overflow-auto min-w-[20rem] bg-white border rounded-lg p-1 mt-0 divide-y divide-gray-200" aria-labelledby="hs-dropdown-with-icons">
