 ...
 //className={`${isLoading ? 'animate-pulse' : ''} min-h-96 min-w-80`}
  return (
    <div > 
      { 
      // isLoading ?
      // <div role="status" class="p-3 max-w-md rounded border border-gray-200 shadow animate-pulse md:p-4 dark:border-gray-700">
      ...
      //                 <div className="h-6 w-6 rounded-full bg-gray-200"></div>
      //         </div>
      //         <div class="h-2.5 w-32 bg-gray-200 rounded-full dark:bg-gray-700"></div>
      //     </div>
