    ...
    <div className=' p-3 '>
      <div className='flex items-center space-x-4'>
        ...
        <div className='flex-1 min-w-0'>
          ...
          <p className='text-sm text-gray-500 truncate dark:text-gray-400'>{following?.email}</p>
        </div>
        <div className='inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white'>
          <button className='bg-teal-500 p-2 rounded-md text-teal-50'>- unfollow</button>
        </div>
      </div>
    </div>
  );
