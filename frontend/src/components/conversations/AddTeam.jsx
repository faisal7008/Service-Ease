...
export default function AddTeam() {
  ...
  return (
    <div className='mx-1 hs-dropdown relative sm:inline-flex z-30 [--auto-close:inside]'>
      <button
      ...
      {/* Dropdown Menu */}
      <div
        className='hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden mt-2 bg-white shadow-md rounded-lg'
      ...
      >
        ...
        >
          {managers
            ?.filter((manager) => manager._id !== currentUser._id)
            ?.map((manager) => (
              <li key={manager._id}>
