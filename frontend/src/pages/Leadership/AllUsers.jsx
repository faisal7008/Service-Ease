                  ...
                  {allUsers.length > 0 ? (
                    allUsers?.map((member, key) => {
                      const className = `py-3 px-5 ${
                        key === allUsers.length - 1 ? '' : 'border-b border-blue-gray-50'
                      }`;
                      ...
                      return (
                        <tr key={member._id}>
                          ...
                          <td className={className}>
                            <div className='flex items-center gap-4'>
                              <Avatar
                                ...
                                src={member.profilePicture ? member.profilePicture : userimg}
                                alt={member.name}
                                size='sm'
                              />
                          ...
                          <td className={className}>
                            ...
                            >
                              {key % 2 == 0 ? (
                                <Button className='px-2 py-1 lowercase tracking-wide rounded bg-green-500 text-white'>
                                  online
                                </Button>
                              ) : (
                          ...
                          <td className={`${className} w-72`}>
                            <Button className='px-3 py-1.5 mr-2 text-xs font-medium text-gray-700 bg-gray-200 shadow-none rounded hover:text-gray-900 hover:bg-gray-300'>
                              edit
                            </Button>
                            <Button
                              onClick={() => navigate('/leadership/community')}
                              className='px-3 py-1.5 mr-2 text-xs font-medium text-gray-700 bg-gray-200 shadow-none rounded hover:text-gray-900 hover:bg-gray-300'
                            >
                              chat
                            </Button>
                            <Button
                              onClick={() => handleDelete(member._id)}
                              className='px-3 py-1.5 text-xs font-medium text-gray-700 bg-gray-200 shadow-none rounded hover:text-gray-900 hover:bg-gray-300'
                            >
                              remove
                            </Button>
                          </td>
