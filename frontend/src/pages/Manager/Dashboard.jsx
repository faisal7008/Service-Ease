...
{/* <!-- drawer component --> */}
<div id="drawer-navigation" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-all duration-300" tabindex="-1" aria-labelledby="drawer-navigation-label">
