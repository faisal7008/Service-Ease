...
const very_dissatisfied = submissions?.filter(submission => submission.responses.some(response => response.answer === "very dissatisfied"))
console.log(very_dissatisfied)
  ...
  <div className={"hs-accordion hs-accordion-active:bg-white rounded-xl px-5 py-3"} id={`streched-${key+1}`}>
    <button className="hs-accordion-toggle hs-accordion-active:text-teal-600 group py-3 inline-flex items-center justify-between gap-x-3 w-full font-semibold text-left text-gray-800 transition hover:text-gray-500" aria-controls={`collapsed-${key+1}`}>
      ...
      <Chip className=" text-end bg-teal-500 px-2 py-1" value={moment(survey.expirydate).format('ll')} />
      ...
      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead>
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">very dissatisfied</th>
              <th scope="col" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">somewhat dissatisfied</th>
              <th scope="col" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">somewhat satisfied</th>
              <th scope="col" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">very satisfied</th>
            </tr>
          </thead>
          <tbody>
