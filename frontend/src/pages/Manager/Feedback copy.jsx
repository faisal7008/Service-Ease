      ...
      <main className='m-10'>
        {surveys.map((survey, key) => (
          <div className='hs-accordion-group'>
            <div className='hs-accordion' id={`survey-${key + 1}`}>
              <button
                className='hs-accordion-toggle hs-accordion-active:text-teal-600 group py-3 inline-flex items-center justify-between gap-x-3 w-full font-semibold text-left text-gray-800 transition hover:text-gray-500 dark:hs-accordion-active:text-teal-500 dark:text-gray-200 dark:hover:text-gray-400'
                aria-controls='hs-basic-with-title-and-arrow-stretched-collapse-one'
              >
                {survey.name}
                <svg
                  className='hs-accordion-active:hidden hs-accordion-active:text-teal-600 hs-accordion-active:group-hover:text-teal-600 block w-3 h-3 text-gray-600 group-hover:text-gray-500 dark:text-gray-400'
                  width='16'
                  height='16'
                  viewBox='0 0 16 16'
                  fill='none'
                ...
                <svg
                  className='hs-accordion-active:block hs-accordion-active:text-teal-600 hs-accordion-active:group-hover:text-teal-600 hidden w-3 h-3 text-gray-600 group-hover:text-gray-500 dark:text-gray-400'
                  width='16'
                  height='16'
                  viewBox='0 0 16 16'
                  fill='none'
