    ...
    <footer className="p-4 bg-gray-900 text-white shadow md:px-6 md:py-8 dark:bg-gray-900">
      <div className="sm:flex sm:items-center sm:justify-between">
        <a href="/" className="flex justify-center items-center mb-4 sm:mb-0">
          {/* <img src={MainLogo} className="mr-3 mt-1 h-10" alt="CBIT Logo" /> */}
          <h1 className="font-mono -mt-1 text-white text-2xl font-semibold">Service<span className="text-3xl ml-1 mr-1 text-teal-500">@</span>Ease</h1>
        </a>
