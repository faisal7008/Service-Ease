    ...
    <div className='h-screen grid place-content-center'>
      ...
      <div className='flex items-center flex-col justify-center py-28 px-6 md:px-24 md:py-20 lg:py-16 gap-8'>
        ...
        <div className='w-full grid justify-items-center'>
          ...
          <button
            onClick={() => navigate(-1)}
            className='w-full lg:w-auto my-4 rounded-md px-1 sm:px-8 py-4 bg-teal-600 text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-700'
          >
            Go back
          </button>
        </div>
