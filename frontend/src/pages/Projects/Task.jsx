    ...
    <>
      ...
      <div className='flex min-h-[91vh]'>
        ...
        <div
          ...
          className='hs-overlay hs-overlay-open:translate-x-0 hidden -translate-x-full fixed top-0 left-0 transition-all duration-300 transform h-full w-72 z-[60] bg-white border-r'
          tabindex='-1'
        >
          <TaskSidebar project={project} current={current} setCurrent={setCurrent} />
        </div>
        <main className='flex w-full lg:w-4/5 overflow-auto bg-white justify-left relative'>
          ...
          <button
            type='button'
            className='py-2 px-0 lg:hidden rounded-r-md border border-transparent font-semibold bg-slate-300 shadow-lg focus:outline-none transition-all text-sm absolute top-10 left-0 z-50'
