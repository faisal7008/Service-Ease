...
// get conversations
export const getDMs = createAsyncThunk('conversations/getDMs', async (userId, thunkAPI) => {
  try {
...
// get conversations
export const getTeams = createAsyncThunk('conversations/getTeams', async (userId, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const createDM = createAsyncThunk('conversations/createDM', async (data, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
// create teams
export const createTeam = createAsyncThunk('conversations/createTeam', async (data, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const deleteConversation = createAsyncThunk('conversations/delete', async (id, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
